...
def test_performance(env, actor, num_tests=1000, reward_fn=None, new_water_food_loc=False):
    """
...
def create_a2c_agent(env,
                     ...
                     plot_results=False, new_water_food_loc=False):
    """
    ...
    final_episode_rf, final_episode_re, final_episode_fit = test_performance(env, actor_critic.actor, reward_fn=user_reward_fn, new_water_food_loc=new_water_food_loc)
    ...
    return actor_critic.actor, episode_rewards, episode_fitness, episode_returns, trajs, final_episode_fit
