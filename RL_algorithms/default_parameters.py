...
default_sarsa_hyper_params = {"alg": "Sarsa",
                                "env_timesteps": 200,
                                "num_environments": 10,
                                "alpha_lr": 0.05,
                                "epsilon": 0.15,
...
default_expected_sarsa_hyper_params = {"alg": "Expected_Sarsa",
                                "env_timesteps": 200,
                                "num_environments": 10,
                                "alpha_lr": 0.05,
                                "epsilon": 0.15,
...
default_param_lookup = {"Q_Learn": default_q_learn_hyper_params,
                        "Sarsa": default_sarsa_hyper_params,
                        "Expected_Sarsa": default_expected_sarsa_hyper_params,
